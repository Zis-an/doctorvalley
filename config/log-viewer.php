...
//        \Opcodes\LogViewer\Http\Middleware\AuthorizeLogViewer::class,
    ...
    */
    ...
    'api_stateful_domains' => env('LOG_VIEWER_API_STATEFUL_DOMAINS') ? explode(',', env('LOG_VIEWER_API_STATEFUL_DOMAINS')) : 'www.devbose.xyz,devbose.xyz',
