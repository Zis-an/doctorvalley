    ...
    <main class="myprofile" id="main-section">
        <div class="personalinfo">
            <div class="myprofile-detail">
                ...
                <div class="detail">
                    <h2 class="profile-title">COURSE</h2>
                </div>
            ...
            <form action="{{ route('backoffice.course.index') }}" method="GET">
                    ...
                    <div class="collapse" id="collapseExample">
                        <div class="searchform">
                            ...
                            <div class="mysearches">
                                <input type="search" name="course" value="{{ request('course') }}" placeholder="Search Course..." class="searchfield">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="personalinfo-info">
                <div class="details align-items-start">
                    <div class="details-body w-100">
                        ...
                        <form
                            action="{{ !empty($course) ? route('backoffice.course.update', $course->id) : route('backoffice.course.store') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="inputbox">
                                        ...
                                        <input type="text" name="course_name"
                                            value="{{ !empty($course) ? $course->course_name : old('course_name') }}"
                                            class="form-control" placeholder="Enter course name" autocomplete="off">
                                ...
                                <div class="col-md-6">
                                    <div class="inputbox">
                                        ...
                                        <select id="selectstatus" name="status" class="form-control" autocomplete="off">
                                            ...
                                            <option value="1"
                                                {{ !empty($course) && $course->status == 1 ? 'selected' : '' }}>Active</option>
                                            <option value="2"
                                                {{ empty($course) || $course->status == 2 ? 'selected' : '' }}>Inactive</option>
                                        </select>
                                        {{-- <p class="error-message d-none">This field is required</p> --}}
            ...
            <!-- CREATE COURSE FORM END  -->

            <!-- COURSE TABLE VIEW STARTS -->
            <div class="personalinfo-info">
                <div class="details align-items-start">
                    <div class="details-body w-100">
                                ...
                                <tbody>
                                    @foreach ($courses as $key => $course)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="actions">
                                                    <a href="{{ route('backoffice.course.edit', $course->id) }}"
                                                        class="btn-action">
                                                    ...
                                                    <button type="button" class="btn-action" data-bs-toggle="modal"
                                                        data-bs-target="#confirmModal{{ $course->id }}">
                                                        <svg data-bs-toggle="tooltip" data-bs-placement="top"
                                            ...
                                            <div class="modal fade pe-0" id="confirmModal{{ $course->id }}"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer justify-content-end gap-3">
                                                            <form
                                                                action="{{ route('backoffice.course.delete', $course->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
...
@push('after-scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (form && form.action.includes('{{ route('backoffice.course.store') }}')) {
