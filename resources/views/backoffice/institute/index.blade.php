    ...
    <main class="myprofile" id="main-section">
        <div class="personalinfo">
            <div class="myprofile-detail">
                ...
                <div class="detail">
                    <h2 class="profile-title">INSTITUTE</h2>
                </div>
            ...
            <form action="{{ route('backoffice.institute.index') }}" method="GET">
                    ...
                    <div class="collapse" id="collapseExample">
                        <div class="searchform">
                            ...
                            <div class="mysearches">
                                <input type="search" name="institute" value="{{ request('institute') }}" placeholder="Search Institute..." class="searchfield">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="personalinfo-info">
                <div class="details align-items-start">
                    <div class="details-body w-100">
                        ...
                        <form
                            action="{{ !empty($institute) ? route('backoffice.institute.update', $institute->id) : route('backoffice.institute.store') }}"
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="inputbox">
                                        ...
                                        <input type="text" name="institute_name"
                                            value="{{ !empty($institute) ? $institute->institute_name : old('institute_name') }}"
                                            class="form-control" placeholder="Enter institute name" autocomplete="off">
                                        {{-- <p class="error-message d-none">This field is required</p> --}}
                                        @if ($errors->has('institute_name'))
                                            <p class="error-message">{{ $errors->first('institute_name') }}</p>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="inputbox">
                                        ...
                                        <select id="selectstatus" name="status" class="form-control" autocomplete="off">
                                            ...
                                            <option value="1"
                                                {{ !empty($institute) && $institute->status == 1 ? 'selected' : '' }}>Active</option>
                                            <option value="2"
                                                {{ empty($institute) || $institute->status == 2 ? 'selected' : '' }}>Inactive</option>
                                        </select>
                                        {{-- <p class="error-message d-none">This field is required</p> --}}
                                ...
                                <div class="col-12">
                                    <div class="inputbox">
                                        <label for="status" class="inputlabel">
                                            Institute Address <span>*</span>
                                        </label>
                                        {{-- <input type="text" name="institute_address"
                                            value="{{ !empty($institute) ? $institute->institute_address : old('institute_address') }}"
                                            class="form-control" placeholder="Enter institute address" autocomplete="off"> --}}
                                        <textarea name="institute_address" class="form-control" placeholder="Enter institute address" rows="4" cols="50" autocomplete="off">{{ !empty($institute) ? $institute->institute_address : old('institute_address') }}</textarea>
                                    </div>
                                </div>
                            ...
                            <table class="table" aria-describedby="table">
                                ...
                                <tbody>
                                    @foreach ($institutes as $key => $institute)
                                        <tr>
                                            <th scope="row">{{ ($institutes->currentPage() - 1) * $institutes->perPage() + $loop->iteration }}</th>
                                            <td class="text-center">{{ $institute->institute_name }}</td>
                                            <td class="text-center">{{ $institute->institute_address }}</td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="actions">
                                                    <a href="{{ route('backoffice.institute.edit', $institute->id) }}"
                                                        class="btn-action">
                                                        <svg data-bs-toggle="tooltip" data-bs-placement="top"
                                                            data-bs-title="Edit Institute"
                                                    ...
                                                    <button type="button" class="btn-action" data-bs-toggle="modal"
                                                        data-bs-target="#confirmModal{{ $institute->id }}">
                                                        <svg data-bs-toggle="tooltip" data-bs-placement="top"
                                                            data-bs-title="Delete Institute"
                                                            xmlns="http://www.w3.org/2000/svg" width="16"
                                            ...
                                            <div class="modal fade pe-0" id="confirmModal{{ $institute->id }}"
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            <h5 class="delete-title">Are you sure you want to delete
                                                                {{ $institute->institute_name }}?</h5>
                                                        </div>
                                                        <div class="modal-footer justify-content-end gap-3">
                                                            <form
                                                                action="{{ route('backoffice.institute.delete', $institute->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
...
@push('after-scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (form && form.action.includes('{{ route('backoffice.institute.store') }}')) {
