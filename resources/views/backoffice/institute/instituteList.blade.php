                ...
                <div class="d-flex justify-content-between w-100">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="detail w-auto">
                            <h2 class="profile-title">INSTITUTE LIST</h2>
                        </div>
                    </div>
                            ...
                            <table class="table" aria-describedby="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="actions">
                                                <a href="{{ route('backoffice.institute.create') }}" class="btn-action">
                                                    <svg data-bs-toggle="tooltip" data-bs-placement="top"
                                                        data-bs-title="Edit Institute" xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <button type="button" class="btn-action" data-bs-toggle="modal"
                                                    ...
                                                    <svg data-bs-toggle="tooltip" data-bs-placement="top"
                                                        data-bs-title="Delete Institute" xmlns="http://www.w3.org/2000/svg"
                                                        width="16" height="16" fill="currentColor"
