    ...
    <main class="myprofile" id="main-section">
        <div class="personalinfo">
            <div class="myprofile-detail">
                ...
                <div class="detail">
                    <h2 class="profile-title">THANA</h2>
                </div>
            ...
            <form action="{{ route('backoffice.area.index') }}" method="GET">
                    ...
                    <div class="collapse" id="collapseExample">
                        <div class="searchform">
                            ...
                            <div class="mysearches">
                                <input type="search" name="area" value="{{ request('area') }}" placeholder="Search Thana..." class="searchfield">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="inputbox">
                                        ...
                                        <input type="text" name="area_name" oninput="this.value = this.value.replace(/[0-9]/g, '')"
