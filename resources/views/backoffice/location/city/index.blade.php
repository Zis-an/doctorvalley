    ...
    <main class="myprofile" id="main-section">
        <div class="personalinfo">
            <div class="myprofile-detail">
                ...
                <div class="detail">
                    <h2 class="profile-title">DISTRICT</h2>
                </div>
            ...
            <form action="{{ route('backoffice.city.index') }}" method="GET">
                    ...
                    <div class="collapse" id="collapseExample">
                        <div class="searchform">
                            ...
                            <div class="mysearches">
                                <input type="search" name="city" value="{{ request('city') }}" placeholder="Search District..." class="searchfield">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="inputbox">
                                        ...
                                        <input type="text" name="city_name" oninput="this.value = this.value.replace(/[0-9]/g, '')"
            ...
            <!-- CREATE DISTRICT FORM END  -->

            <!-- DISTRICT TABLE VIEW STARTS -->
            <div class="personalinfo-info">
                <div class="details align-items-start">
                    <div class="details-body w-100">
                            ...
                            <table class="table" aria-describedby="table">
                                ...
                                <tbody>
                                    @foreach ($cities as $key => $city)
                                        <tr>
                                            <th scope="row">{{ ($cities->currentPage() - 1) * $cities->perPage() + $loop->iteration }}</th>
                                            ...
                                            <td>
                                                <div class="actions">
                                                    ...
                                                    <button type="button" class="btn-action" data-bs-toggle="modal"
                                                        data-bs-target="#confirmModal{{ $city->id }}">
                                                        <svg data-bs-toggle="tooltip" data-bs-placement="top"
                                                            data-bs-title="Delete District"
                                                            xmlns="http://www.w3.org/2000/svg" width="16"
                                            ...
                                            <div class="modal fade pe-0" id="confirmModal{{ $city->id }}"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer justify-content-end gap-3">
                                                            <form
                                                                action="{{ route('backoffice.city.delete', $city->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
