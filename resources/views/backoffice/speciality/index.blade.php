    ...
    <main class="myprofile" id="main-section">
        <div class="personalinfo">
            <div class="myprofile-detail">
                ...
                <div class="detail">
                    <h2 class="profile-title">SPECIALITY</h2>
                </div>
            ...
            <form action="{{ route('backoffice.speciality.index') }}" method="GET">
                    ...
                    <div class="collapse" id="collapseExample">
                        <div class="searchform">
                            ...
                            <div class="mysearches">
                                <input type="search" name="speciality" value="{{ request('speciality') }}" placeholder="Search Speciality..." class="searchfield">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- CREATE SPECIALITY FORM  START-->
            <div class="personalinfo-info">
                <div class="details align-items-start">
                    <div class="details-body w-100">
                        <!-- ADD-PERSONAL-INFORMATION -->
                        <form
                            action="{{ !empty($speciality) ? route('backoffice.speciality.update', $speciality->id) : route('backoffice.speciality.store') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="inputbox">
                                        ...
                                        <input type="text" name="speciality_name"
                                            value="{{ !empty($speciality) ? $speciality->speciality_name : old('speciality_name') }}"
                                            class="form-control" placeholder="Enter speciality name" autocomplete="off">
                                        {{-- <p class="error-message d-none">This field is required</p> --}}
                                        @if ($errors->has('speciality_name'))
                                            <p class="error-message">{{ $errors->first('speciality_name') }}</p>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="inputbox">
                                        ...
                                        <select id="selectstatus" name="status" class="form-control" autocomplete="off">
                                            ...
                                            <option value="1"
                                                {{ !empty($speciality) && $speciality->status == 1 ? 'selected' : '' }}>Active</option>
                                            <option value="2"
                                                {{ empty($speciality) || $speciality->status == 2 ? 'selected' : '' }}>Inactive</option>
                                        </select>
                                        {{-- <p class="error-message d-none">This field is required</p> --}}
                                ...
                                <div class="col-12">
                                    <div class="edubtns">
                                        <button class="btn-profile-add">
                                            {{ !empty($speciality) ? 'Update' : 'Create' }}
                                        </button>
                                    </div>
                                </div>
                            </div>
            ...
            <!-- CREATE SPECIALITY FORM END  -->

            <!-- SPECIALITY TABLE VIEW STARTS -->
            <div class="personalinfo-info">
                <div class="details align-items-start">
                    <div class="details-body w-100">
                        <div class="table-responsive">
                            <table class="table" aria-describedby="table">
                                <thead>
                                    <tr>
                                        <th scope="col">SL</th>
                                        <th scope="col" class="text-center">Speciality Name</th>
                                ...
                                <tbody>
                                    @foreach ($specialities as $key => $speciality)
                                        <tr>
                                            <th scope="row">{{ ($specialities->currentPage() - 1) * $specialities->perPage() + $loop->iteration }}</th>
                                            <td class="text-center">{{ $speciality->speciality_name }}</td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="actions">
                                                    <a href="{{ route('backoffice.speciality.edit', $speciality->id) }}"
                                                        class="btn-action">
                                                        <svg data-bs-toggle="tooltip" data-bs-placement="top"
                                                            data-bs-title="Edit Speciality"
                                                    ...
                                                    <button type="button" class="btn-action" data-bs-toggle="modal"
                                                        data-bs-target="#confirmModal{{ $speciality->id }}">
                                                        <svg data-bs-toggle="tooltip" data-bs-placement="top"
                                                            data-bs-title="Delete Speciality"
                                                            xmlns="http://www.w3.org/2000/svg" width="16"
                                            ...
                                            <div class="modal fade pe-0" id="confirmModal{{ $speciality->id }}"
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            <h5 class="delete-title">Are you sure you want to delete
                                                                {{ $speciality->speciality_name }}?</h5>
                                                        </div>
                                                        <div class="modal-footer justify-content-end gap-3">
                                                            <form
                                                                action="{{ route('backoffice.speciality.delete', $speciality->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                ...
                <div class="mt-5 d-flex justify-content-center">
                    <nav aria-label="Page navigation example" aria-labelledby="nav">
                        <x-pagination :items="$specialities" />
                    </nav>
                </div>
                <!-- PAGINATION ENDS -->
            </div>
...
@push('after-scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (form && form.action.includes('{{ route('backoffice.speciality.store') }}')) {
