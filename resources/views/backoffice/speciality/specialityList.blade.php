                ...
                <div class="d-flex justify-content-between w-100">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="detail w-auto">
                            <h2 class="profile-title">SPECIALITY LIST</h2>
                        </div>
                    </div>
                                        ...
                                        <td>
                                            <div class="actions">
                                                ...
                                                <button type="button" class="btn-action" data-bs-toggle="modal"
                                                    ...
                                                    <svg data-bs-toggle="tooltip" data-bs-placement="top"
                                                        data-bs-title="Delete Speciality" xmlns="http://www.w3.org/2000/svg"
                                                        width="16" height="16" fill="currentColor"
                                        ...
                                        <td>
                                            <div class="actions">
                                                ...
                                                <button type="button" class="btn-action" data-bs-toggle="modal"
                                                    data-bs-target="#confirmModal">
                                                    <svg data-bs-toggle="tooltip" data-bs-placement="top"
                                                        data-bs-title="Delete Area" xmlns="http://www.w3.org/2000/svg"
                                                        width="16" height="16" fill="currentColor"
                                                        class="bi bi-trash" viewBox="0 0 16 16">
                                                        <path
                                                            d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5Zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5Zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6Z" />
