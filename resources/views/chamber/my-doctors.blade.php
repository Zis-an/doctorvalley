                        ...
                        <div class="mydoctors">
                            <div class="mydoctor">
                                <div class="mydoctor-detail">
                                    <figure class="thumb">
                                        <img src="../assets/images/avatar/profile.svg" alt="doctor-thumb">
                                    </figure>

                                    <div class="detail">
                                        <h5 class="name">Doctor Stephen Strange</h5>
                                        <p class="text">MBBS, MD (Pediatric Hematology & Oncology)</p>
                                        <p class="text">Dhaka Medical College & Hospital</p>
                                ...
                                <div class="mydoctor-info">
                                    <a href="{{ route('chamber.schedule.create') }}" class="btn-calendar">
                                        <span class="icon">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Remove doctor from doctor list</p>
                </div>
