                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="inputbox">
                                                ...
                                                <input type="text" id="bmdcnumber" class="form-control"
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="inputbox">
                                                ...
                                                <input type="tel" pattern="[0-9]{3}-[0-9]{8}" id="phonenumber"
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="socialbox">
                                                ...
                                                <div class="detail">
                                                    <input type="text" placeholder="https://facebook.com/ratulalmamun"
                                                        autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="socialbox">
                                                ...
                                                <div class="detail">
                                                    <input type="text" placeholder="https://twitter.com/ratulalmamun"
                                                        autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="socialbox">
                                                ...
                                                <div class="detail">
                                                    <input type="text" placeholder="https://youtube.com/ratulalmamun"
                                                        autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="socialbox">
                                                ...
                                                <div class="detail">
                                                    <input type="text" placeholder="https://linkedin.com/ratulalmamun"
                                                        autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
