<div class="tab-pane fade" id="professionalinformation-tab-pane" role="tabpanel"
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="inputbox">
                                                ...
                                                <input type="text" class="form-control" placeholder="01/01/2016"
                                                    id="starting-calendar" autocomplete="off">
                                                <p class="error-message d-none">This field is required</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="inputbox">
                                                ...
                                                <input type="text" class="form-control" placeholder="31/12/2020"
                                                    id="ending-calendar" autocomplete="off">
                                                <p class="error-message d-none">This field is required</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="checkfield">
                                                <input type="checkbox" class="checkinput" id="currentworking"
                                        ...
                                        <div class="col-12">
                                            <div class="inputbox">
                                                ...
                                                <input type="text" id="institutelocation" class="form-control"
                                    ...
                                    <div class="qualificationlist">
                                        <div class="qualificationlist-item">
                                            ...
                                            <div class="actions">
                                                ...
                                                <button class="btn-delete" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" data-bs-title="Delete">
                                                    <svg width="37" height="37" viewBox="0 0 37 37"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                            d="M25.5561 13.902C26.1417 13.3164 26.1417 12.3652 25.5561 11.7796C24.9704 11.1939 24.0193 11.1939 23.4336 11.7796L18.5 16.7179L13.5617 11.7843C12.976 11.1986 12.0249 11.1986 11.4392 11.7843C10.8536 12.3699 10.8536 13.321 11.4392 13.9067L16.3776 18.8403L11.4439 23.7786C10.8583 24.3643 10.8583 25.3154 11.4439 25.9011C12.0296 26.4867 12.9807 26.4867 13.5664 25.9011L18.5 20.9628L23.4383 25.8964C24.024 26.4821 24.9751 26.4821 25.5608 25.8964C26.1464 25.3107 26.1464 24.3596 25.5608 23.774L20.6224 18.8403L25.5561 13.902Z"
                                                            fill="#292E3E" />
                                                        <path opacity="0.1"
                                                            d="M18.5 37C28.7173 37 37 28.7173 37 18.5C37 8.28273 28.7173 0 18.5 0C8.28273 0 0 8.28273 0 18.5C0 28.7173 8.28273 37 18.5 37Z"
                                                            fill="#F04130" />
