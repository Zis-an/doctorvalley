                ...
                <div class="filternotification">
                    ...
                    <label for="notification-calendar">
                        <svg width="14" height="16" viewBox="0 0 14 16" fill="none"
                            ...
                            <path
                                d="M10.8889 8.55556H7V12.4444H10.8889V8.55556ZM10.1111 0V1.55556H3.88889V0H2.33333V1.55556H1.55556C0.692222 1.55556 0.00777777 2.25556 0.00777777 3.11111L0 14C0 14.8556 0.692222 15.5556 1.55556 15.5556H12.4444C13.3 15.5556 14 14.8556 14 14V3.11111C14 2.25556 13.3 1.55556 12.4444 1.55556H11.6667V0H10.1111ZM12.4444 14H1.55556V5.44444H12.4444V14Z"
                                fill="#F04130" />
                        </svg>
                    </label>
                </div>
                        ...
                        <div class="card-notification">
                            <figure class="listicon">
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                    ...
                                    <defs>
                                        <filter id="icon-1" x="0" y="0" width="18" height="18"
                                        ...
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            ...
                                            <span class="icon">
                                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                                    ...
                                                    <defs>
                                                        <filter id="bullet-icon-1" x="0" y="0" width="18"
                                                            ...
                                                            <feGaussianBlur stdDeviation="2"
                                                                result="effect1_foregroundBlur_32_24" />
                                                        </filter>
                                                    </defs>
                                                </svg>
                                            </span>
                                                        ...
                                                        <span class="arricon">
                                                            <svg width="38" height="38" viewBox="0 0 38 38"
                                                                ...
                                                                <g filter="url(#arrow-1)">
                                                                    <rect x="7" y="7" width="24" height="24"
                                                                        rx="5" fill="#F04130" />
                                                                </g>
                                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                                    d="M25.5172 15.3811C25.8479 15.7865 25.8243 16.3838 25.4463 16.7622L19.604 22.6041C19.4081 22.8 19.1461 22.906 18.8744 22.906C18.6025 22.906 18.341 22.8002 18.1444 22.6041L12.3023 16.762C11.8992 16.3585 11.8992 15.7053 12.3023 15.3028C12.7055 14.8991 13.3589 14.8991 13.7619 15.3027L18.8744 20.4147L23.9867 15.3028C24.3647 14.9243 24.9626 14.9007 25.368 15.2318L25.4464 15.3027L25.5172 15.3811Z"
                                                                    fill="white" />
                                                                <defs>
                                                                    <filter id="arrow-1" x="0" y="0" width="38"
                                                                        height="38" filterUnits="userSpaceOnUse"
                                                                        color-interpolation-filters="sRGB">
                                                                        ...
                                                                        <feGaussianBlur stdDeviation="3.5"
                                                                            result="effect1_foregroundBlur_34_61" />
                                                                    </filter>
                                                                </defs>
                                                            </svg>
                                                        </span>
                                    ...
                                    <div id="collapse-1" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <p class="message">
                                                ...
                                                <br>
                                                We have a good news for you. Now our website has a new feature from next
                                                month. Appointment system is comming soon. From then you will be get a new
                                                option in your dashboard and you will see your appointment list there.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="accordion" id="accordionNotification-2">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse-2" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionNotification-2">
                                        <div class="accordion-body">
                                            <p class="message">
                                                Dear <strong>Doctors,</strong>
                                                <br>
                            ...
                            <div class="accordion" id="accordionNotification-3">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse-3" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionNotification-3">
                                        <div class="accordion-body">
                                            <p class="message">
                                                Dear <strong>Doctors,</strong>
                                                <br>
