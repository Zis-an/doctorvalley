          ...
          <ul class="sidelist">
              ...
              <li class="sidelist-item">
                  <a href="{{ route('backoffice.speciality.create') }}" class="sidelist-link"
                      ...
                      <span class="text">Create Speciality</span>
                  </a>
              </li>

              <li class="sidelist-item">
                  <a href="{{ route('backoffice.speciality.list') }}" class="sidelist-link" data-bs-toggle="tooltip"
                      data-bs-placement="right" data-bs-title="Category List">
                      <span class="icon">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#F04130"
                              class="bi bi-list-task" viewBox="0 0 16 16">
                              <path fill-rule="evenodd"
                      ...
                      <span class="text">Speciality List</span>
                  </a>
              </li>

              <li class="sidelist-item">
                  <a href="{{ route('backoffice.institute.create') }}" class="sidelist-link" data-bs-toggle="tooltip"
                      ...
                      <span class="text">Create Institute</span>
                  </a>
              </li>

              <li class="sidelist-item">
                  <a href="{{ route('backoffice.institute.list') }}" class="sidelist-link" data-bs-toggle="tooltip"
                      data-bs-placement="right" data-bs-title="Institute List">
                      <span class="icon">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#F04130"
                              class="bi bi-building-fill" viewBox="0 0 16 16">
                              <path
                      ...
                      <span class="text">Institute List</span>
                  </a>
              </li>

              <li class="sidelist-item">
                  <a href="{{ route('backoffice.course.create') }}" class="sidelist-link" data-bs-toggle="tooltip"
                      data-bs-placement="right" data-bs-title="Create Course">
                      <span class="icon">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#F04130"
