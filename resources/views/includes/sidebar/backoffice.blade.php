...
<ul class="sidelist">
    <li class="sidelist-item">
        <a href="{{ route('backoffice.dashboard') }}" class="sidelist-link {{ request()->routeIs('backoffice.dashboard') ? 'active' : '' }}" data-bs-toggle="tooltip"
    ...
    <li class="sidelist-item">
        <a href="{{ route('doctor.create') }}" class="sidelist-link {{ request()->routeIs('doctor.create') ? 'active' : '' }}" data-bs-toggle="tooltip"
    ...
    <li class="sidelist-item">
        <a href="{{ route('doctor.index') }}" class="sidelist-link {{ request()->routeIs('doctor.index') ? 'active' : '' }}" data-bs-toggle="tooltip"
    ...
    <li class="sidelist-item">
        <a href="{{ route('blog.create') }}" class="sidelist-link {{ request()->routeIs('backoffice.blog.create') ? 'active' : '' }}" data-bs-toggle="tooltip"
    ...
    <li class="sidelist-item">
        <a href="{{ route('blog.index') }}" class="sidelist-link {{ request()->routeIs('backoffice.blog.index') ? 'active' : '' }}" data-bs-toggle="tooltip"
    ...
    <li class="sidelist-item">
        <a href="{{ route('backoffice.degree.create') }}" class="sidelist-link {{ request()->routeIs('backoffice.degree.create') ? 'active' : '' }}" data-bs-toggle="tooltip"
           data-bs-placement="right" data-bs-title="Degree">
                      <span class="icon">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#F04130"
    ...
    <li class="sidelist-item">
        <a href="{{ route('feedback.index') }}" class="sidelist-link {{ request()->routeIs('feedback') ? 'active' : '' }}" data-bs-toggle="tooltip"
